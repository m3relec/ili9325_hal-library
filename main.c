//PORT FROM AVR TO STM32 BY MASOUD REZAPOUR
//telegram : @M3RElec
//website : smartelc.ir
#include "main.h"
#include "stm32f1xx.h"
...
lcd_background_color(BLACK);
  ...
  Reverse=1;
  FgColor=CYAN;
  TextBox(240,3,190,240,"Masoud Rezapour",ALINE_CENTER);
  lcd_write_pic(60,60,name);
  rot=0;
  Reverse=0;
  lcd_draw_circle(120,295,20,1,RED);
  RoundRectangle(20,280, 60, 315, 8, 1, YELLOW);
  RoundRectangle(180,280,219,315, 8, 1, BLUE);
  lcd_draw_line(0,270,239,270,WHITE);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PA0 PA1 PA2 PA3 
                           PA4 PA5 PA6 PA7 */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3 
                          |GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_12;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
